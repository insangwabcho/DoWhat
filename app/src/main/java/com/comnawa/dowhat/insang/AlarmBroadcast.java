...
public class AlarmBroadcast extends BroadcastReceiver {
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    builder.setSmallIcon(R.drawable.green).setTicker("현재시각 등록해놓은 일정이 있습니다").setWhen(System.currentTimeMillis())
      .setNumber(1).setContentTitle("푸쉬 제목").setContentText(intent.getStringExtra("push"))
